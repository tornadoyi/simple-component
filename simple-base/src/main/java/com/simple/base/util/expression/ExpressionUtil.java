 ...
 * @version 1.0 2009-11-06 11:44:31
 * @since 1.0
 */
public class ExpressionUtil {
     ...
     * @return 返回构建好的表达式对象
     */
    public static Expression buildExpression(String expressionRule) {
     ...
     * @return 返回构建好的表达式对象
     */
    private static Expression buildExpression(LinkedList<String> operators) {
     ...
     * @return 返回二元操作对象
     */
    private static BinaryOperationExpression getBinaryExpression(char operator) {
        ...
        switch (operator) {
            ...
            default:
                throw new RuntimeException("Unkown operator " + operator + " for table partition.");
        }
    }
